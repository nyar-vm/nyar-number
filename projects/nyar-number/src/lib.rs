...
pub use self::{
    ...
    types::{
        atomic_type::{number::ValkyrieNumber, ValkyrieAtomicType},
        class_type::ValkyrieClassType,
        literal_type::ValkyrieLiteralType,
        tuple_type::ValkyrieTable,
        union_type::ValkyrieUnionType,
        variant_type::ValkyrieVariantType,
        ValkyrieType,
    },
